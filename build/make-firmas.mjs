  ...
  <tr>
    <td colspan="2" style="padding:14px 0 0;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border-top:1px solid ${LINE};width:100%;">
        ...
        <tr><td style="padding:8px 0 0;font-family:${SANS};font-size:10px;line-height:14px;color:#8E8A80;">Este mensaje y sus adjuntos son confidenciales y se dirigen exclusivamente a su destinatario. Si lo ha recibido por error, comuníquelo al remitente y elimínelo sin copiarlo ni difundirlo. Su contenido no constituye oferta ni compromiso contractual: las propuestas, precios y condiciones de VELUM solo vinculan cuando constan en documento firmado por las partes. Sus datos se tratan para gestionar la relación comercial; puede ejercer sus derechos en <a href="mailto:${c.privacyEmail}" style="color:#8E8A80;text-decoration:underline;">${c.privacyEmail}</a> y consultar la información completa en <a href="${DOMAIN}/politica-de-privacidad/" target="_blank" style="color:#8E8A80;text-decoration:underline;">nuestra política de privacidad</a>.</td></tr>
        <tr><td style="padding:6px 0 0;font-family:${SANS};font-size:10px;line-height:14px;color:#8E8A80;" lang="en">This message and any attachments are confidential and intended solely for the addressee. If you have received it in error, please notify the sender and delete it. Nothing in this message constitutes a binding offer or agreement unless set out in a document signed by the parties. Privacy notice: <a href="${DOMAIN}/en/privacy-policy/" target="_blank" style="color:#8E8A80;text-decoration:underline;">by-velum.com/en/privacy-policy</a>.</td></tr>
      </table>
    </td>
  </tr>
</table>`);
