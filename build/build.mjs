...
function iberiaMap() {
  return `<svg viewBox="0 0 420 340" class="iberia" aria-hidden="true" fill="none">
    <path d="M52 96 L120 70 L210 66 L300 78 L356 70 L372 110 L356 150 L378 196 L352 250 L300 286 L232 300 L150 286 L96 252 L60 196 L44 150 Z"
      fill="var(--ink)" fill-opacity="0.06" stroke="var(--ink)" stroke-opacity="0.45" stroke-width="1.4"/>
    <path d="M44 150 L96 168 L120 232 L96 252 L60 196 Z" fill="var(--mist)" stroke="var(--soft)" stroke-opacity="0.5" stroke-width="1.2"/>
    <circle cx="250" cy="150" r="5" fill="var(--ink)"/><circle cx="180" cy="200" r="5" fill="var(--ink)"/>
    <circle cx="300" cy="210" r="4" fill="var(--ink)" fill-opacity="0.6"/><circle cx="150" cy="120" r="4" fill="var(--ink)" fill-opacity="0.6"/>
    <circle cx="108" cy="210" r="5" fill="var(--soft)"/>
  </svg>`;
}
